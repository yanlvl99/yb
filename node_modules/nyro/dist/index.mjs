...
var Core = class _Core extends EventEmitter {
  ...
  */
  async request(options2, currentRedirects = 0, attempt = 1, visitedUrls = /* @__PURE__ */ new Set()) {
    ...
    if (options2?.params) {
      const params = new URLSearchParams(options2.params);
    ...
    if (options2?.proxy) {
      ...
      requestOptions.agent = protocol.includes("socks") ? new SocksProxyAgent(`${protocol}://${proxyAuth ? `${proxyAuth}@` : ""}${proxyUrl}`) : isHttps ? new HttpsProxyAgent(`${protocol}://${proxyAuth ? `${proxyAuth}@` : ""}${proxyUrl}`) : new HttpProxyAgent(`${protocol}://${proxyAuth ? `${proxyAuth}@` : ""}${proxyUrl}`);
    }
...
__reExport(proxyManager_exports, fastgate_star);
import Proxy2 from "fastgate";
import * as fastgate_star from "fastgate";
var proxyManager_default = Proxy2;
...
var export_Anonymity = proxyManager_exports.Anonymity;
var export_Country = proxyManager_exports.Country;
var export_Format = proxyManager_exports.Format;
var export_OmitedProxyAPIResponse = proxyManager_exports.OmitedProxyAPIResponse;
var export_Protocol = proxyManager_exports.Protocol;
var export_ProxyAPIOptions = proxyManager_exports.ProxyAPIOptions;
var export_ProxyAPIResponse = proxyManager_exports.ProxyAPIResponse;
var export_ProxyFetchOptions = proxyManager_exports.ProxyFetchOptions;
var export_ProxyFilterOptions = proxyManager_exports.ProxyFilterOptions;
var export_ProxyFormat = proxyManager_exports.ProxyFormat;
var export_ProxyObject = proxyManager_exports.ProxyObject;
export {
  androidWebkitVersions as AndroidVersions,
  export_Anonymity as Anonymity,
  chromeWebkitVersions as ChromeVersions,
  ContentType,
  export_Country as Country,
  export_Format as Format,
  Headers2 as Headers,
  Method,
  Nyro,
  ErrorHandler as NyroError,
  export_OmitedProxyAPIResponse as OmitedProxyAPIResponse,
  Options,
  PluginManager as Plugin,
  export_Protocol as Protocol,
  proxyManager_default as Proxy,
  export_ProxyAPIOptions as ProxyAPIOptions,
  export_ProxyAPIResponse as ProxyAPIResponse,
  export_ProxyFetchOptions as ProxyFetchOptions,
  export_ProxyFilterOptions as ProxyFilterOptions,
  export_ProxyFormat as ProxyFormat,
  export_ProxyObject as ProxyObject,
  ResponseEncoding,
  ResponseType,
